        ...
        <Grid container spacing={6} alignItems="center">
          <Grid size={{ xs: 12, md: 7 }}>
            <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.9, mb: 3, fontSize: '1.05rem' }}>
              I specialize in designing and implementing end-to-end data engineering ecosystems that transform raw geospatial and hydrological data into actionable intelligence for policy makers and resource managers. With 9+ years as a data engineering professional in government, I've architected scalable ETL pipelines, data platforms and decision support systems that empower critical decision-making across water resources management, flood forecasting and flood monitoring.
            </Typography>
            <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.9, mb: 3, fontSize: '1.05rem' }}>
